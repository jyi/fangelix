...
/* bool overlapWithMacro(const clang::Stmt *S, SourceManager &srcMgr, const LangOptions &langOpts, */
/*                       Preprocessor &pp, ASTContext* context) { */

/*   class ExprVisitor : public RecursiveASTVisitor<ExprVisitor> { */
/*   public: */
/*     explicit ExprVisitor(ASTContext *Context, SourceManager &srcMgr, const LangOptions &langOpts) */
/*       : Context(Context), srcMgr(srcMgr), langOpts(langOpts) {} */
...
/*       if(startLoc.isMacroID() && !Lexer::isAtStartOfMacroExpansion(startLoc, srcMgr, langOpts)) { */
/*         std::cout << "At macro start: " << toString(S) << "\n"; */
/*         return false; */
/*       } */

/*       if(endLoc.isMacroID() && !Lexer::isAtEndOfMacroExpansion(endLoc, srcMgr, langOpts)) { */
/*         std::cout << "At macro end: " << toString(S) << "\n"; */
/*         return false; */
/*       } */
...
/*   class ExprASTConsumer : public ASTConsumer { */
/*   public: */
/*     explicit ExprASTConsumer(const Stmt *S, ASTContext *C, SourceManager &srcMgr, */
/*                              const LangOptions &langOpts) : S(S), C(C), V(C, srcMgr, langOpts) {} */

/*     virtual void HandleTranslationUnit(clang::ASTContext &Context) { */
/*       V.TraverseStmt((Stmt*)S); */
/*     } */
/*   private: */
/*     const Stmt *S; */
/*     ASTContext *C; */
...
/*   ExprASTConsumer *cons = new ExprASTConsumer(S, context, srcMgr, langOpts); */
/*   cons->HandleTranslationUnit(*context); */
/*   delete cons; */
/*   return false; */
/* } */
...
StatementMatcher RepairableVarDeclNode =
  declRefExpr(to(varDecl(anyOf(hasType(isInteger()),
                               hasType(pointerType()),
                               hasType(qualType()))))).bind("repairable");

StatementMatcher RepairableImplicitCastExpr =
  implicitCastExpr(hasSourceExpression(RepairableVarDeclNode));

StatementMatcher RepairableNode =
  anyOf(unaryOperator(hasOperatorName("!")).bind("repairable"),
        RepairableVarDeclNode,
        RepairableImplicitCastExpr,
