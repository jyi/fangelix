 ...
 */
public class ProgramVariable extends Variable implements Comparable<ProgramVariable> {
    private String name;
    private Type type;
    ...
    @Override
    public int compareTo(ProgramVariable o) {
        if (this.equals(o)) return 0;

        if (getName().equals(o.getName())) {
            return getType().getNum() - o.getType().getNum();
        } else {
